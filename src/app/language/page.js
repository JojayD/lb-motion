...
function LanguageSelection() {
  ...
  const getConfigId = () => {
    switch (difficulty) {
      case "easy":
        return "db090a99-a760-41ce-a044-974216c42bc8";
      case "medium":
      ...
      {step === 1 ? (
        ...
        <>
          <div className="w-full max-w-sm mx-auto">
            <h1 className="text-3xl font-bold text-black text-center bg-white text-gray-800 px-4 py-2 rounded-t-lg shadow-md focus:outline-none">Select Difficulty</h1>
            {language && (
          ...
          <div className="flex space-x-4 mt-2">
            <button
              className={`px-4 py-2 rounded-lg shadow-md focus:outline-none transform transition duration-300 ease-in-out hover:scale-105 ${difficulty === "easy" ? "bg-blue-500 text-white" : "bg-white text-gray-800"}`}
              onClick={() => handleDifficultySelect("easy")}
            >
              Easy
            </button>
            <button
              className={`px-4 py-2 rounded-lg shadow-md focus:outline-none transform transition duration-300 ease-in-out hover:scale-105 ${difficulty === "medium" ? "bg-blue-500 text-white" : "bg-white text-gray-800"}`}
              onClick={() => handleDifficultySelect("medium")}
            >
              Medium
            </button>
            <button
              className={`px-4 py-2 rounded-lg shadow-md focus:outline-none transform transition duration-300 ease-in-out hover:scale-105 ${difficulty === "hard" ? "bg-blue-500 text-white" : "bg-white text-gray-800"}`}
